...
import pattern_printer.domain.helpers.StitchNodeHelpers;

public class StrInputToStitchesConverter {
    ...
    public StitchNode convertInputToStitches(String input, StitchGlossary stitchTypes) {
